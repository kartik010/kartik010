<!-- ============================================================
     Kartik Sharma — GitHub Profile README
     github.com/kartik010
     ============================================================ -->
...
Premium lifestyle & fashion brand based in Dehradun. Hired as their Shopify developer to audit and redesign the existing store — no platform migration, precision surgery inside the **Prestige theme by Maestrooo**. Target aesthetic: ultra-luxury comparable to Hermès, Loro Piana, Diptyque.
...
2. Studied reference brands (bonadea.com, goodearth.in) and defined the Riviera Cream direction — warm ivory, editorial spacing, refined type
3. Rebuilt `header.liquid` from scratch — custom CSS and JS all prefixed `mc-` to avoid Prestige theme conflicts
4. Redesigned homepage sections — hero, collections grid, editorial strips — using Cormorant Garamond + Jost
...
2. Integrated Mux — built upload pipeline (pre-signed URLs → Mux ingest), adaptive bitrate player, auto-generated thumbnails
...
- Sub-cent fees, ~400ms finality on Solana mainnet
...
</div>- Stale hero banners from old seasonal campaigns
- Broken 404 pages on multiple collection routes
- Empty `alt` tags across all product images (SEO + accessibility failure)
- Duplicated mega-menu entries causing navigation confusion
- No consistent typographic hierarchy on product pages
